...
const imageSelts = document.querySelector(".Selts");
const imageSugukond = document.querySelector(".Sugukond");
...
function showInfo(event) {
    ...
    if (event.target.classList.contains('active')) {
        ...
        imageSelts.textContent = "Selts: " + images[key]['Selts'];
        imageSugukond.textContent = "Sugukond: " + images[key]['Sugukond'];
    } else {
        imageEst.textContent = "Eestikeelne nimi: "; // Очищаем текст при снятии выделения
        imageLat.textContent = "Ladinakeelne nimi: ";
        imageSelts.textContent = "Selts: "; // Очищаем текст при снятии выделения
        imageSugukond.textContent = "Sugukond: ";
    }
